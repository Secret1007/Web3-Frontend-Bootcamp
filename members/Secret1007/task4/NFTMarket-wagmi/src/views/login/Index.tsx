    ...
    return (
        <>
            <div className=" rounded-lg shadow-lg w-full h-full flex items-center justify-center">
                ...
                <button onClick={() => {}} type="button" className="connector-btn flex items-center mb-2  w-40 py-2 px-4 bg-dark-500 text-white rounded hover:bg-dark-700 cursor-pointer ml-4">
